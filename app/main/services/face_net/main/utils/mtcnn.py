...
from main.utils.detect_face import detect_face, extract_face
...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = f'{MODELS_PATH}/pnet.pt'
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = f'{MODELS_PATH}/rnet.pt'
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = f'{MODELS_PATH}/onet.pt'
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
